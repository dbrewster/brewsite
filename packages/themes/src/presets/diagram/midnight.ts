// midnight DiagramTheme preset — warm cinematic tone with bronze/amber authority.

import type { DiagramTheme } from '@brewsite/diagram';

export const midnightTheme: DiagramTheme = {
  node: {
    defaultColor: '#261A13FF',
    defaultBoxColor: '#3D2E22FF',
    ...
    cornerRadius: '0.9%',
    glowIntensity: 0.0,
    defaultLabelColor: '#F2E7D4FF',
    defaultSublabelColor: '#BCA180FF',
    labelSizeFactor: 1.0,
  ...
  edge: {
    defaultColor: '#E2A33AFF',
    defaultFlowColor: '#D0634BFF',
  ...
  group: {
    defaultColor: '#1A120DFF',
    defaultBorderColor: '#7D603CFF',
