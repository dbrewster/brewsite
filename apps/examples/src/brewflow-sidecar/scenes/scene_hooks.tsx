...
export const SceneHooks = () => (
  <Scene key="bf-hooks" id="bf-hooks">
    ...
    <TextBox id="hooks-prose" x={0} y={0.08} w={1} h={0.92}>
      <div style={{
              ...
              <tbody>
                {[
                  ...
                  <tr key={v} style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                    <td style={{ padding: '5px 8px 5px 0', color: '#8ab4f8', fontFamily: 'JetBrains Mono, monospace', fontSize: '13px' }}>{v}</td>
                    <td style={{ padding: '5px 0', color: 'rgba(180, 200, 240, 0.75)', fontSize: '13px' }}>{d}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div style={{ padding: '12px 16px', background: 'rgba(20, 28, 60, 0.5)', borderRadius: 6, border: '1px solid rgba(100, 140, 220, 0.12)' }}>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '13px', color: 'rgba(100, 140, 220, 0.7)', marginBottom: 6 }}>pre-task</div>
                <code style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '13px', color: '#8ab4f8', display: 'block', lineHeight: 1.6, whiteSpace: 'pre' }}>
                  {`command: npx brewflow recall
capture: stdout
timeout_ms: 3000
on_failure: skip`}
                </code>
                <div style={{ fontSize: '13px', color: 'rgba(180, 200, 240, 0.65)', marginTop: 8, lineHeight: 1.6 }}>
              ...
              <div style={{ padding: '12px 16px', background: 'rgba(20, 28, 60, 0.5)', borderRadius: 6, border: '1px solid rgba(100, 140, 220, 0.12)' }}>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '13px', color: 'rgba(100, 140, 220, 0.7)', marginBottom: 6 }}>post-task</div>
                <code style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '13px', color: '#8ab4f8', display: 'block', lineHeight: 1.6, whiteSpace: 'pre' }}>
...
on_failure: skip`}
              ...
              <div style={{ padding: '12px 16px', background: 'rgba(20, 28, 60, 0.5)', borderRadius: 6, border: '1px solid rgba(100, 140, 220, 0.12)' }}>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '13px', color: 'rgba(100, 140, 220, 0.7)', marginBottom: 6 }}>session-end</div>
                <code style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '13px', color: '#8ab4f8', display: 'block', lineHeight: 1.6, whiteSpace: 'pre' }}>
...
on_failure: skip`}
        ...
        <div style={{ marginTop: 24, padding: '16px', background: 'rgba(20, 28, 60, 0.4)', borderRadius: 6, borderLeft: '3px solid rgba(100, 140, 220, 0.3)' }}>
          <div style={{ fontSize: '15px', fontWeight: 600, color: '#c8d8f0', marginBottom: 8 }}>Queen system prompt addendum</div>
