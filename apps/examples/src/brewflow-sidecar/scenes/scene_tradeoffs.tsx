        ...
        <div>
          ...
          <ul style={{ margin: 0, padding: '0 0 0 16px', display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              ...
              <li key={i} style={{ fontSize: '0.89rem', color: 'rgba(220, 180, 180, 0.8)', lineHeight: 1.6 }}>{item}</li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              ...
              <div key={period}>
                <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '0.72rem', color: 'rgba(100, 140, 220, 0.7)', marginBottom: 4 }}>{period}</div>
                <div style={{ fontSize: '0.83rem', color: 'rgba(180, 200, 240, 0.7)', lineHeight: 1.6 }}>{desc}</div>
              </div>
            ))}
          </div>
        </div>
