...
export const SceneBridge = () => (
  <Scene key="bf-bridge" id="bf-bridge">
    ...
    <TextBox id="bridge-prose" x={0} y={0.18} w={1} h={0.82}>
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <h3 style={{ fontSize: '18px', color: '#c8d8f0', margin: '20px 0 12px', fontWeight: 600 }}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={src} style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                    <td style={{ padding: '6px 8px 6px 0', color: 'rgba(200, 220, 255, 0.6)', fontFamily: 'JetBrains Mono, monospace', fontSize: '13px' }}>{src}</td>
                    <td style={{ padding: '6px 0', color: 'rgba(180, 200, 240, 0.75)', fontSize: '13px' }}>{dst}</td>
                  </tr>
                ))}
              </tbody>
            </table>
