...
export const sceneDim3Context: JSX.Element = (
  <Scene key="bfc-dim3-context" id="bfc-dim3-context">
    ...
    <InputController scope="canvas">
      <Action id="pan" type="diagram-canvas.move" canvasId="bfc-ctx-canvas">
        <PointerMap event="drag" axis="xy" />
        <WheelMap axis="xy" />
      </Action>
      <Action id="rotate" type="diagram-canvas.rotate" canvasId="bfc-ctx-canvas">
        <PointerMap event="drag" button="left" modifiers={['meta']} axis="xy" />
      </Action>
      <Action id="reset" type="diagram-canvas.reset" canvasId="bfc-ctx-canvas">
        <KeyMap keyName="r" />
      </Action>
    </InputController>

    <DiagramCanvas id="bfc-ctx-canvas" x={0} y={0} w={1} h={0.56} tilt={config.diagramRotationX} scale={config.diagramScale} theme={brewflowTheme}>
      <Diagram id="ctx-diagram">
