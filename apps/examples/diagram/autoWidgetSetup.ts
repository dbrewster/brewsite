  ...
  const canvasDefault = compileCanvas(
    ...
    [
      compileDiagram({
        ...
        pivot: 'center',
        nodes: [
          { id: 'browser', label: 'Web Browser',    icon: 'ui:user' },
